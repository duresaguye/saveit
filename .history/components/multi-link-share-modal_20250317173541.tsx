          ...
          <TabsContent value="link" className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                <Checkbox id="include-metadata" checked={includeMetadata} onCheckedChange={(checked) => setIncludeMetadata(checked === true)}                <Label htmlFor="include-metadata">Include tags and descriptions</Label>
              </div>
            </div>
