...
export default function FolderDetailPage() {
    ...
    const loadData = () => {
      ...
      if (currentFolder) {
        ...
        const folderLinkObjects = currentFolder.links
          ...
          .filter(Boolean) // Remove any undefined links (in case a link was deleted)
  ...
  const handleRemoveLink = (linkId) => {
    if (folder) {
      ...
      toast({
        title: "Link removed",
        description: "Link removed from folder",
      })
    }
  }
  ...
  const handleAddNewLink = (newLink) => {
    ...
    toast({
      title: "Link added",
      description: `${newLink.title} has been added to the folder.`,
    })
  }
